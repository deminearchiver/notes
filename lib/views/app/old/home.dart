...
import 'package:notes/views/app/old/notes.dart';
import 'package:notes/views/app/old/todos.dart';
                  ...
                  return SliverList.list(
                    children: [
                      ...
                      if (otherTodos.isNotEmpty)
                        SectionHeader(
                          localizations.app_home_view_todos(otherTodos.length),
                          icon: const Icon(
                      ...
                      if (otherNotes.isNotEmpty)
                        SectionHeader(
                          localizations.app_home_view_notes(otherNotes.length),
                      ...
                      if (completedTodos.isNotEmpty)
                        SectionHeader(
                          localizations
                              .app_home_view_completed(completedTodos.length),
