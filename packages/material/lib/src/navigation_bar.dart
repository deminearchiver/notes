...
/// widget. The [NavigationBar] has three [NavigationBarDestination] widgets and
...
/// [NavigationBarDestination] widgets with different color schemes. Its
...
///  * [BottomNavigationBar]
///  * <https://api.flutter.dev/flutter/material/NavigationBarDestination-class.html>
...
class NavigationBar extends StatelessWidget {
  ...
  /// [NavigationBarDestination] values.
  ...
  /// the [NavigationBarDestination] is focused, hovered, or pressed.
                ...
                Expanded(
                  child: _SelectableAnimatedBuilder(
                    ...
                    builder:
                      ...
                      return _NavigationBarDestinationInfo(
                        index: i,
...
class NavigationBarDestination extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final _NavigationBarDestinationInfo info =
        _NavigationBarDestinationInfo.of(context);
    ...
    return _NavigationBarDestinationBuilder(
      label: label,
      tooltip: tooltip,
      enabled: enabled,
...
/// according to [_NavigationBarDestinationInfo.selectedAnimation], where an
/// animation value of 0 is unselected and 1 is selected.
///
/// See [NavigationBarDestination] for an example.
class _NavigationBarDestinationBuilder extends StatefulWidget {
  ...
  /// [_NavigationBarDestinationInfo.selectedAnimation]. When the animation is 0,
  ...
  ///
  /// To animate between unselected and selected, build the icon based on
  /// [_NavigationBarDestinationInfo.selectedAnimation]. When the animation is
...
/// `_NavigationBarDestinationInfo.of(context)`.
class _NavigationBarDestinationInfo extends InheritedWidget {
  /// Adds the information needed to build a navigation destination to the
  /// [child] and descendants.
  const _NavigationBarDestinationInfo({
    required this.index,
    required this.selectedIndex,
  ...
  /// Returns a non null [_NavigationBarDestinationInfo].
  ///
  /// This will return an error if called with no [_NavigationBarDestinationInfo]
  /// ancestor.
  ///
  ...
  static _NavigationBarDestinationInfo of(BuildContext context) {
    final _NavigationBarDestinationInfo? result = context
        .dependOnInheritedWidgetOfExactType<_NavigationBarDestinationInfo>();
    assert(
      result != null,
      'Navigation destinations need a _NavigationBarDestinationInfo parent, '
  ...
  @override
  bool updateShouldNotify(_NavigationBarDestinationInfo oldWidget) {
...
/// destination, based on [_NavigationBarDestinationInfo.labelBehavior] and
/// [_NavigationBarDestinationInfo.selectedAnimation].
///
/// Depending on the [_NavigationBarDestinationInfo.labelBehavior], the labels
...
/// [_NavigationBarDestinationInfo.labelBehavior].
///
...
///
/// Requires a [_NavigationBarDestinationInfo] parent (normally provided by the
...
class _NavigationBarDestinationSemantics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _NavigationBarDestinationInfo destinationInfo =
        _NavigationBarDestinationInfo.of(context);
...
class _NavigationBarDestinationLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  /// selected.
  ///
  /// See [_NavigationBarDestinationInfo.selectedAnimation].
